...
class Base:
    ...
    This Represents base for classes in project 
    ...
    def to_json_string(list_dictionaries):
        ...
        Args:
            list_dictionaries (list): A list dictionaries.
        """
    ...
    def create(cls, **dictionary):
        """Return class instante from dictionary of attributes.
    ...
    def load_from_file(cls):
        """Return list of class instance from file JSON strings.
